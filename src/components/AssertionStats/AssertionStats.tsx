...
const AssertionStats: React.FC<AssertionStatsProps> = ({ stats }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Assertion Statistics</h3>
      ...
      <div className="flex items-start gap-6">
        <div className="flex-1 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-gray-900 dark:text-white font-medium">{stats.passed}</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-gray-900 dark:text-white font-medium">{stats.failed}</span>
          </div>
          
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <ShieldOff className="w-5 h-5 text-yellow-500 dark:text-yellow-400" />
              <span className="text-gray-600 dark:text-slate-300">Unavailable</span>
            </div>
            <span className="text-gray-900 dark:text-white font-medium">{stats.unavailable}</span>
          </div>
          
          <div className="pt-4 border-t border-gray-200 dark:border-slate-700">
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{passRate}%</p>
              <p className="text-sm text-gray-600 dark:text-slate-400">Pass Rate</p>
            </div>
          </div>
        </div>
