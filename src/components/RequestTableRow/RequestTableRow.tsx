                ...
                {result.requirements && (result.requirements.passed > 0 || result.requirements.failed > 0) && (
                  <div className={`rounded-lg p-4 shadow-sm ${
                    ...
                    <div className="text-sm">
                      {/* Requirements Chart */}
                      <div>
                        <div key={`chart-${result.id || index}-${theme}`} id={`chart-${result.id || index}`} className="w-full h-28" ref={el => {
                          if (el) {
                          ...
                          <div className="space-y-1">
                            {result.requirements.percentiles.map((req, idx) => (
                              <div key={idx} className="flex items-center justify-between text-xs">
                                <span className="text-gray-600 dark:text-slate-400">{req.percentile}th:</span>
