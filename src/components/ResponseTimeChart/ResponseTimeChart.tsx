  ...
  return (
    <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Response Time Percentiles</h3>
      </div>
        ...
        {percentiles.map((percentile) => (
          <div key={percentile.label} className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-gray-600 dark:text-slate-300">{percentile.label} Percentile</span>
              <span className="text-gray-900 dark:text-white font-medium">{percentile.value}ms</span>
            </div>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-slate-700">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="text-gray-900 dark:text-white ml-2">{responseTimes.min}ms</span>
            </div>
            <div>
              <span className="text-gray-600 dark:text-slate-400">Max:</span>
              <span className="text-gray-900 dark:text-white ml-2">{responseTimes.max}ms</span>
            </div>
          </div>
        </div>
      </div>
